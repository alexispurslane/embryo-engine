// All credits for this code go to Michael Fairley's project,
// which you can find here: https://github.com/michaelfairley/rust-imgui-opengl-renderer/blob/master/src/lib.rs.
// I just copied his code instead of using his Cargo crate
// because his cargo crate came with its own gl bindings,
// which I don't need/want, and it loaded GL itself, which
// I also didn't want.
...
impl Renderer {
    pub fn new(imgui: &mut Context, gl: &gl::Gl) -> Self {
        unsafe {
            #[cfg(target_os = "macos")]
